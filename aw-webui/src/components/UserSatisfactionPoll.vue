<template lang="pug">
  div
    b-alert(v-if="isPollVisible", variant="info", show)
      ...
      form
        p
          | Hey there! You've been using TimeBench for a while. How likely are you to recommend it to a friend/colleague on a scale 1-10? (with 10 being the most likely)
    ...
    b-alert(v-if="isPosFollowUpVisible", variant="info" show)
      ...
      | We're really happy to hear you are enjoying TimeBench, but we think we can do even better! To help us help you, here are a few things you can do:
      ul
        li
          | Support us on #[a(href="https://www.patreon.com/erikbjare") Patreon] or #[a(href="https://opencollective.com/timebench") Open Collective] (or by #[a(href="https://timebench.net/donate/") other donation methods]).
        li
          | Using TimeBench at work? Consider asking your employer to support us!
        li
          | Post about it on social media and tell your friends and colleagues! We are on #[a(href="https://twitter.com/TimeBenchIt") Twitter] and #[a(href="https://www.facebook.com/TimeBench") Facebook].
        //li
          | Sign up for the newsletter.
        li
          | Vote for new features on the #[a(href="https://forum.timebench.net/c/features") forum].
        //li
          | Fill out the #[a(href="https://forms.gle/q2N9K5RoERBV8kqPA") feedback form].
        li
          | Rate us on #[a(href="https://alternativeto.net/software/timebench/") AlternativeTo] and #[a(href="https://play.google.com/store/apps/details?id=net.timebench.android") Google Play Store].
        li
    ...
    b-alert(v-if="isNegFollowUpVisible", variant="info" show)
      ...
      | We are sorry to hear that you did not like TimeBench, but we want to improve! We would be very thankful if you helped us by:
      ul
        li
          | Fill out the #[a(href="https://forms.gle/q2N9K5RoERBV8kqPA") feedback form].
        li
