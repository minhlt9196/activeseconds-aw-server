export const window_events = [
  {
    ...
    data: {
      app: 'Firefox',
      title: 'TimeBench/timebench: Track how you spend your time - Mozilla Firefox',
      url: 'https://github.com/TimeBench/timebench',
      $category: ['Work', 'Programming', 'TimeBench'],
    },
  },
  {
    duration: 14.6 * 60,
  ...
  },
  {
    ...
    data: {
      app: 'Terminal',
      title: 'vim ~/code/timebench/aw-server/aw-webui/src',
      $category: ['Work', 'Programming', 'TimeBench'],
    },
  },
  {
